...
<template>
  <div class="actions-bar-wrapper">
    <div class="actions-bar">
      <circa-button @click.native="sync('all')" class="sync-btn" faIcon="fas fa-sync">Sync All</circa-button>
      <circa-button @click.native="sync('products')" class="sync-btn" faIcon="fas fa-sync">Sync Products</circa-button>
      <circa-button @click.native="sync('images')" class="sync-btn" faIcon="fas fa-sync">Sync Images</circa-button>
